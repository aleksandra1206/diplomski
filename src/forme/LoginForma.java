...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPassword.setText("aleksandra1206");
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            ...
            b.setPassword(new String(txtPassword.getPassword()));
            b.setDodatiClanovi(new ArrayList<>());
            b.setOceneKnjiga(new ArrayList<>());

            Bibliotekar bibliotekar = ClientController.getInstance().login(b);
            Session.getInstance().setUlogovani(bibliotekar);
